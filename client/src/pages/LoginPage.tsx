  ...
  return (
    <div className="min-h-screen bg-background-dark flex items-center justify-center">
      <div className="bg-card-dark p-8 rounded-lg shadow-lg w-full max-w-md border border-subtle-border">
        <h2 className="text-2xl font-bold text-light-text mb-2 text-center">Welcome Back</h2>
        <p className="text-mid-gray mb-6 text-center">Log in to continue</p>
        ...
        <p className="text-mid-gray text-sm text-center mt-4">
          Don't have an account? <Link to="/register" className="text-primary-blue hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
